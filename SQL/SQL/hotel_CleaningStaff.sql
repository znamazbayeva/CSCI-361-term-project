...
CREATE TABLE `CleaningStaff` (
  ...
  CONSTRAINT `fk_CleaningStaff_Employee1` FOREIGN KEY (`EmployeeID`) REFERENCES `Employee` (`idEmployee`)
...
INSERT INTO `CleaningStaff` VALUES (7),(10),(11);
...
-- Dump completed on 2020-10-19 14:20:12
