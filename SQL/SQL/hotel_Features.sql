...
CREATE TABLE `Features` (
  ...
  PRIMARY KEY (`RoomTypeName`,`HotelID`,`Features`),
  CONSTRAINT `fk_Features_Room Type1` FOREIGN KEY (`RoomTypeName`) REFERENCES `Room Type` (`RoomTypeName`)
...
-- Dump completed on 2020-10-19 14:20:01
