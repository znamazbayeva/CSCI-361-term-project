...
CREATE TABLE `AdministrativeStaff` (
  ...
  CONSTRAINT `fk_Manager_Employee1` FOREIGN KEY (`EmployeeID`) REFERENCES `Employee` (`idEmployee`)
...
INSERT INTO `AdministrativeStaff` VALUES (1),(2),(3),(4),(5),(8);
...
-- Dump completed on 2020-10-19 14:20:09
